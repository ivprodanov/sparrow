...
export const Thing = ({ description, children, event, cardImage, imageAlt, cardTitle, className, ...rest }) => {
  ...
  return ComponentMappings(component, children, event, cardImage, imageAlt, cardTitle, className, rest);
};
