...
export const Thing = ({ description, children, event, cardImage, imageAlt, cardTitle }) => {
  ...
  return ComponentMappings(component, children, event, cardImage, imageAlt, cardTitle);
};
